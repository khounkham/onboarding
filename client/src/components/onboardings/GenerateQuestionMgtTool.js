...
const GenerateQuestionMgtTool = (props) => {
  ...
  const onChangeSelectRadioMgtTool = (i, e) => {
    ...
    console.log('props of Radio Selection', props)
    return (
              ...
              <td>
                    <td><span className="questionLabel">How long are you familiar with {val.collectionName}?</span></td>                     
                      <label className="containerRadio">No experience
                          <input name="mgtTool" type="radio" checked={props.scoreOfMgtTool == "0<score<=3"} onChange={e=>onChangeSelectRadioMgtTool(idx,e)} value="0<score<=3"/>
                          <span className="checkmarkRadio" ></span>
                      </label>
                      <label className="containerRadio">Abit experience
                          <input name="mgtTool" type="radio" checked={props.scoreOfMgtTool == "3<score<=5"} onChange={e=>onChangeSelectRadioMgtTool(idx,e)} value="3<score<=5"/>
                          <span className="checkmarkRadio" ></span>
                      </label>
                      <label className="containerRadio">Alot of experience
                          <input name="mgtTool" type="radio" checked={props.scoreOfMgtTool == "5<score<=8"} onChange={e=>onChangeSelectRadioMgtTool(idx,e)} value="5<score<=8"/>
                          <span className="checkmarkRadio"></span>
                      </label>
