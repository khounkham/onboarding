...
const onChange = e => setFormData({...formData, [e.target.name] : e.target.value });
    ...
    return (
      ...
      <p className="lead">
        <i className="fas fa-code-branch"></i> Add any work
      ...
      <form className="form" onSubmit ={e => {
        ...
        <div className="form-group">
          <input type="text" placeholder="* Organization/Company" name="company" value={company} onChange={e=> onChange(e)} required />
        </div>
        <div className="form-group">
